            ...
            "messages": [
                {
                    ...
                    "content": (
                        ...
                        "1-2 ：几乎没训练痕迹，完不成基本书写\n\n"
                        "【标签要求】\n"
                        "必须从以下候选标签中选择 2-4 个最贴合的标签，不要自造标签。\n"
                        "如果作品明显优秀，优先选择正向标签；如果存在问题，选择具体问题标签。\n"
                        "不要输出“笔顺有误”，除非输入包含书写过程、视频或轨迹数据。\n"
                        "正向标签：结构工整、结构稳定、重心稳当、重心居中、笔法到位、笔画有力、运笔流畅、起收笔清晰、主笔突出、收放自然、疏密得当、穿插合理、避让自然、大小协调、间距均匀、整体整洁\n"
                        "问题标签：结构失衡、结构松散、中宫松散、中宫过紧、主笔不突出、比例失调、部件错位、部件拥挤、穿插不当、避让不足、收放失衡、字形歪斜、重心不稳、重心偏左、重心偏右、重心偏上、重心偏下、左右失衡、上下失衡、笔法有误、运笔生硬、笔画无力、笔画过细、笔画过粗、粗细失衡、起笔草率、收笔草率、起收笔不清、横画不稳、竖画不直、撇捺角度不当、转折生硬、大小不一、间距不均、行列不齐、布局拥挤、留白不当、墨迹不匀、页面不整洁、图像不清晰\n\n"
                        "【批改风格要求】\n"
                        "- 先肯定优点，再指出问题，最后给修改方向\n"
