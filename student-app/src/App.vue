...
const stageCopy = computed(() => {
  ...
  if (currentNav.value.to === "/submit") {
    return "提交页是联调最关键的一步。学生上传作品后直接触发 AI 评测，结果会即时回流到学习记录与教师端。";
  }

  return "成长档案把平均得分、问题标签和练习建议沉淀下来，便于答辩时讲清系统如何支持持续性的个性化反馈。";
});
  ...
  <div class="shell">
    ...
    <aside class="sidebar">
      <div class="brand-rail">
        ...
        <p class="rail-copy">
          围绕“领任务、交作品、看反馈、记成长”组织学生侧学习体验，让整套系统既能演示，也能看起来像真正的产品。
        </p>
      </div>
