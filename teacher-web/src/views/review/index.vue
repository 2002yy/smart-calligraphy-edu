      ...
      <article v-for="review in filteredReviews" :key="review.id" class="review-line">
        ...
        <div class="review-body">
          ...
          <div class="review-scores" v-if="review.structure_score != null">
            ...
            <div class="mini-score"><span>笔法</span><b>{{ review.stroke_quality_score ?? review.stroke_order_score }}</b></div>
          </div>
          ...
          <div class="drawer-content">
            ...
            <section class="drawer-section">
              ...
              <div class="drawer-sub-scores" v-if="activeReview.structure_score != null">
                ...
                <article><span>笔法</span><b>{{ activeReview.stroke_quality_score ?? activeReview.stroke_order_score }}</b></article>
              </div>
            </section>
